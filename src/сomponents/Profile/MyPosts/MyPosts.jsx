...
import { addPostActionCreaator, updateNewPostTextActionCreaator } from '../../../redux/state';
...
const MyPosts = (props) => {
  ...
  let addPost = () => {
    let action = addPostActionCreaator();
    props.dispatch(action);
  }

  let onPostChange = () => {
    let text = newPostElement.current.value;
    let action = updateNewPostTextActionCreaator(text);
    props.dispatch(action);
  }
